...
<nav class="navbar navbar-inverse navbar-expand-xl navbar-dark">
	<div class="navbar-header d-flex col">
		<a class="navbar-brand" href="#">white<b>panda</b></a>  			
	</div>

	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">		
		<ul class="nav navbar-nav navbar-right ml-auto">	
			<li class="nav-item"><a href="#" class="nav-link notifications"><i class="fa fa-bell-o"></i><span class="badge">67</span></a></li>
...
<img id="img1" src="avatar.jpg" alt="Avatar" style="width:65px">
...
<img id="img1" src="avatar1.jpg" alt="Avatar" style="width:65px; position: absolute;
    TOP: 580px;
    left: 500px;">
...
<img id="img1" src="avatar.jpg" alt="Avatar" style="width:65px; position: absolute;
    TOP: 580px;
    left: 890px;">
...
<div class="copyright grey-text text-center ">
     Copyright  ©  2018  White  Panda  Media  Pvt.  Ltd.<br>All rights reserved<br><br>
	 <u>Privacy  policy</u>&ensp;|&ensp;<u>Terms  of  service</u>&ensp;|&ensp;<u>Service  Agreement</u>&ensp;|&ensp;<u>Contact us</u>
</div>
